...
const Sidebar: React.FC<SidebarProps> = ({
  ...
  const renderTabContent = useCallback(() => {
    ...
    return userJoinedSpaces?.map((item) => renderItem(item, isEventsTab));
  }, [
    selectedTab,
    isUserSpaceLoading,
    userJoinedSpaces,
  ...
  return (
    ...
    >
      <ScrollShadow className="flex-1 overflow-y-auto" visibility="bottom">
        ...
        <div
          className={`mx-[10px] flex flex-col justify-between gap-[5px] rounded-[10px] border-t border-[#383838] py-[10px]`}
        >
