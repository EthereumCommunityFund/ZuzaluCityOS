    ...
    Tables: {
      ...
      betaEvents: {
        Row: {
          ...
          startTime: string;
          status: string | null;
          superadmin: Json | null;
          supportchain: string | null;
          tagline: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: 'betaEvents_space_id_fkey';
            columns: ['space_id'];
            isOneToOne: false;
            referencedRelation: 'betaSpaces';
            referencedColumns: ['id'];
          },
        ];
      };
      ...
      installed_apps: {
        Row: {
          ...
          installed_pensieve_app_id: string | null;
          native_app_name: string | null;
          space_id: string | null;
          external_app_data: Json | null;
        };
        Insert: {
          created_at?: string;
          id?: string;
